...
public class myWriterAdapterView extends BaseAdapter {
    ...
    String get_id;
    public myWriterAdapterView(Context context,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        imageLoader.DisplayImage(resultp.get(myWriter.IMAGE_URL), image); //imageLoader에 있는 displayimage를 사용하여 이미지 사용
