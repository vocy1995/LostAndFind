...
public class CreateBoardActivity extends AppCompatActivity {
    ...
    //EditText 객체 및 변수 선언
    EditText location, storage_location, content;
    String location_text, storage_location_text, content_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_save.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                }else if((location_text.length() == 0)) {   //보관장소확인
                    Toast.makeText(getApplicationContext(), "빈공간이 있습니다.",Toast.LENGTH_SHORT).show();
                }else if((storage_location_text.length() == 0)) {   //습득장소 확인
                    Toast.makeText(getApplicationContext(), "빈공간이 있습니다.",Toast.LENGTH_SHORT).show();
        ...
        btn_map.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = new Intent(getApplicationContext(), MapPrintActivity.class);
